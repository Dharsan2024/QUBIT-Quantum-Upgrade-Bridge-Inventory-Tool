# Vendored from authlib (BSD-3-Clause), jose/rfc7518/jwe_algs.py — regression fixture only.
# Reliably triggered a tree-sitter 0.26.0 binding SIGSEGV during scanning; kept to guard the pin.
import secrets
import struct
